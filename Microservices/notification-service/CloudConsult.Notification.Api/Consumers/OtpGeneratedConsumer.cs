...
using CloudConsult.Notification.Api.Events;
using Kafka.Public;
using MailKit.Net.Smtp;
using System.Text;
using System.Text.Json;

namespace CloudConsult.Notification.Api.Consumers
{
    public class OtpGeneratedConsumer : IHostedService
    {
        ...
        public async Task ProcessMessage(RawKafkaRecord record)
        {
            try
            {
                ...
                {
                    logger.LogError($"Invalid message consumed from topic: {"user-otp-generated"}");
                    return;
                }
