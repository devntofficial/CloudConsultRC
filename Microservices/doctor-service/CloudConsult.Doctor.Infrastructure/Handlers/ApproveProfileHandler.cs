...
{
    public class ApproveProfileHandler : ICommandHandler<ApproveProfile>
    {
        private readonly IApiResponseBuilder builder;
        private readonly IKycService kycService;

        public ApproveProfileHandler(IApiResponseBuilder builder, IKycService kycService)
        {
            this.builder = builder;
            this.kycService = kycService;
        }

        public async Task<IApiResponse> Handle(ApproveProfile request, CancellationToken cancellationToken)
        {
