...
{
    public class ConsultationBookedEventProducer : IJob
    {
        private readonly ILogger<ConsultationBookedEventProducer> _logger;
        private readonly IMapper _mapper;
        private readonly IProducer<Null, string> _producer;
        private readonly IConsultationEventService _eventService;
        private readonly QuartzConfiguration _config;
        
        public ConsultationBookedEventProducer(
            ILogger<ConsultationBookedEventProducer> logger,
            IMapper mapper,
        ...
        public async Task Execute(IJobExecutionContext context)
        {
            try
            {
                ...
                {
                    var mappedEvent = _mapper.Map<ConsultationBookedEvent>(consultation);
