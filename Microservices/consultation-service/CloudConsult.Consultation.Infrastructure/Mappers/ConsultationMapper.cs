...
namespace CloudConsult.Consultation.Infrastructure.Mappers
{
    public class ConsultationMapper: Profile
    {
        ...
        {
            CreateMap<BookConsultationCommand, ConsultationBookingEntity>()
            ...
            CreateMap<ConsultationBookingEntity, ConsultationBookedEvent>()
        ...
        private DateTime BookingEndDateMapper(BookConsultationCommand data)
        {
        ...
        private DateTime BookingStartDateMapper(BookConsultationCommand data)
        {
