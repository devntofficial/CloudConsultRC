...
{
    public class GetAvailabilityProcessor : IQueryProcessor<GetAvailabilityQuery, DoctorAvailabilityResponse>
    {
        private readonly IApiResponseBuilder<DoctorAvailabilityResponse> _builder;
        private readonly IAvailabilityService _service;
        private readonly IMapper _mapper;

        public GetAvailabilityProcessor(IApiResponseBuilder<DoctorAvailabilityResponse> builder,
        ...
        public async Task<IApiResponse<DoctorAvailabilityResponse>> Handle(GetAvailabilityQuery request, CancellationToken cancellationToken)
        {
